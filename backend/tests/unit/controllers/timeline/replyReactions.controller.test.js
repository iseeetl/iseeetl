jest.mock('../../../../services/timeline/replyReactions.service', () => ({
  create: jest.fn(),
  delete: jest.fn(),
}));

const service = require('../../../../services/timeline/replyReactions.service');
const controller = require('../../../../controllers/timeline/replyReactions.controller.js');

describe('返信リアクションのコントローラ', () => {
  ...
  describe('作成', () => {
    test('body, jwt, io を渡す', async () => {
      const body = { reply_id: 'RP1', type: 'like' };
    ...
    test('サービスのエラーをnextへ渡す', async () => {
      const body = { reply_id: 'RP1', type: 'love' };
